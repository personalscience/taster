...
RUN echo "options(repos = c(REPO_NAME = 'https://packagemanager.rstudio.com/cran/__linux__/focal/2021-11-09'), download.file.method = 'libcurl', Ncpus = 4)" >> /usr/local/lib/R/etc/Rprofile.site
...
RUN Rscript -e 'remotes::install_github("personalscience/cgmr@923772f946d74bd022f4c9fb3323f1afe2b1b317")'
