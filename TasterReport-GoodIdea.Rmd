...
food_results %>% filter(!is.na(meal)) #filter(str_detect(meal, "RSprague-8/31-Cream of Wheat"))

normalize_value(food_results) %>% transmute(t,value,meal = paste(foodname,date_ch)) %>%
